...
router.post("/", (req, res) => {
  ...
  uploadCertis(req, res, async (err) => {
    ...
    if (flag) {
      ...
      const extc = ['D4A', 'D4B', 'D9A', 'D9B', 'D14A', 'D14B', 'D14C', 'D19A', 'D19B', 'D19C'];
      const cmpn = ['D2A', 'D2B', 'D2C', 'D7A', 'D7B', 'D7C', 'D12A', 'D12B', 'D12C', 'D17A', 'D17B', 'D17C'];
      ...
      for (i = 0; i < certificates.length - 1; i++) {
        ...
        if (etrx.includes(certificates[i].division))
          branch = 'Electronics';
